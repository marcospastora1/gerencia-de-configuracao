<%-- Document : Home Created on : 27 de ago. de 2022, 22:39:10 Author : jeffe --%>
        ...
        <div> <img src="/Imagens do Projeto/home.png" alt="home">
            <div>
                <div> <button><a href="/home"> HOME</a> </button> | <button> <a href="/produtos"> PRODUTOS</a>
                    ...
                    <button><a href="#">SOBRE</a></button> | <button><a href="/faleConosco">CONTATO</a></button> | <button><a href="/fornecedores">FORNECEDORES</a></button>
                </div>
            </div>
            <div>
                ...
                <p>
                    ...
                    inicial. Não pontuaram alteração de letras palavras ou mesmo ordem do
                    código. Criar no mínimo duas versões com tag ou com branch. Ter uma branch de desenvolvimento e
                    fazer o merge do código no branch principal.
                </p>
